...
(function(h) {
    ...
    function nb(a) {
        ...
        e.append("<div style=\"float: left; font-family: HelveticaBold; font-size: 16px; color: rgb(54, 88, 159); padding: 5px 0px;\"><b id=\"tableTitle\">Table Title</b><b id=\"titledivider\" style=\"display:none\"> | </b><button id=\"buttonAdd\" style=\"display:none\"><span id=\"buttonAddTitle\">Add Button</span></button></div>");
    ...
    function pb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="' + b.sFilterInput + '" style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.075) inset; transition: border 0.2s linear 0s, box-shadow 0.2s linear 0s; display: inline-block; height: 15px; padding: 4px 6px; color: rgb(85, 85, 85); vertical-align: middle; border-radius: 4px; box-sizing: content-box; width: 206px; line-height: 20px; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; font-size: 14px; font-weight: normal; margin: 6px; font-style: inherit;"/>',
            j = d.sSearch,
    ...
    function ob(a) {
        for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", {
                ...
                "style":"width: 82px;height:25px; background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204);"
...
$(function() {
		$('body').click(function(event){
			if(curr!=null){
				if($(event.target).hasClass("actionImage") || $(event.target).hasClass("myMenu-item")){
					return;
				}else{
...
function checkV(element, n){
	var imagePosition = $("#img"+n).position();
	var imageHeight = document.querySelector(".actionImage").naturalHeight;
	
	if(window.innerHeight-$("#img"+n).offset().top+$(document).scrollTop() < element.offsetHeight+imageHeight){
		element.style.top = imagePosition.top-element.offsetHeight+"px";
	}else{
		element.style.top = imagePosition.top+imageHeight+"px";
	}
	
	element.style.left = imagePosition.left-element.offsetWidth+"px";
}